...
export default function TwoColText({ title, text, list, image, leftColumnClassName, leftColumnImageClassName }: Props) {

  return (
    <section className="pb-10">
      {/* Container */}
      <div className="container flex flex-col items-center justify-between xl:flex-row xl:h-[500px] space-y-6 xl:space-y-0 xl:gap-6">
        ...
        <div className="flex w-full flex-col justify-between rounded-xl bg-background-secondary px-8 py-12 space-y-12 lg:items-start xl:w-1/2 xl:h-full">
          ...
          <div className="flex flex-col items-start">
            <Typography variant="p" className="mb-4 text-darkblue font-robotoFlex font-normal text-[19px]">
              {text}
            </Typography>
          </div>
        </div>
