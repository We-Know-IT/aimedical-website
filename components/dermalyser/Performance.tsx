    ...
    <section className=" bg-background-primary">
      <div className="container ">
        <div className="mx-auto flex scale-y-110 flex-col gap-4 rounded-[20px] bg-background-primary px-4 py-24 shadow-md sm:px-6 md:max-w-5xl md:scale-y-125 md:px-0">
          ...
          <div className="mx-auto h-[4px] w-1/4 scale-y-[0.9] bg-background-secondary md:scale-y-[0.8]"></div>
          <p className="mx-auto scale-y-[0.9] text-center text-lg font-medium  leading-7 text-on-bg-primary md:max-w-xl md:scale-y-[0.8]">
          ...
          <ul className="mx-auto flex flex-row justify-center  gap-4 md:flex-col w-[80%]">
            {bars.map((bar, i) => (
              <li key={i}>
