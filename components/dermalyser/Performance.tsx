...
export default function Performance() {
  return (
    <section className="pb-10">
      <div className="container flex flex-col items-center justify-between xl:flex-row-reverse xl:h-[540px] space-y-6 xl:space-y-0 xl:gap-6">
...
"Backed by rigorous trials, CE-marked approval, and a study published in the British Journal of Dermatology, Dermalyser provides evidence-based decision support you can trust. Learn more in our clinical studies.`}
          ...
          <div className="mt-auto">
            <Link href="/clinical-validation" className="flex items-center justify-center bg-transparent text-primary border-2 border-primary hover:bg-primary hover:text-white transition-colors rounded-full px-4 py-2 lg:px-6 lg:py-3 font-robotoFlex font-normal transition-colors cursor-pointer text-sm lg:text-base">
              Clinical Studies
            </Link>
          </div>
        </div>
