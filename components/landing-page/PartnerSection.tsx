  ...
  return (
    <section className="pb-10">
       <div className="container flex flex-row items-center justify-between xl:flex-col space-y-6 xl:space-y-0 gap-6">
        ...
        >
         <Typography variant="h3" className="font-robotoFlex text-darkblue-page-active font-normal whitespace-nowrap flex-shrink-0 px-8">Our Partners</Typography>
      {/* Mobile marquee */}
      {/* IMPLEMENT */}
      
        {/* Desktop grid */}
        <div className="hidden md:block flex-1 overflow-hidden relative">
          <div className="relative px-8 py-4 h-24">
            <div className="flex gap-8 items-center animate-marquee-horizontal w-[4000px]">
              {/* First set of logos */}
              {partners.map((img, i) => (
                <div
                  key={`marquee-first-${i}`}
